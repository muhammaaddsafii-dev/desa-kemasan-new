...
const Footer = async () => {
  ...
  const lokasi = assets?.lokasi ?? "Kab. Bandung Barat";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <span className="font-bold text-base">{nama}</span>
                <span className="block text-xs opacity-80">{lokasi}</span>
              </div>
            </div>
            <p className="text-sm opacity-80 leading-relaxed">
              Portal resmi {nama} — pusat informasi, layanan publik, dan data desa untuk masyarakat.
            </p>
          </div>
